...
__device__ re_t re_compile(const char* pattern);


/* Find matches of the compiled pattern inside text. */
__device__ int re_matchp(re_t pattern, const char* text, int* matchlength);


/* Find matches of the txt pattern inside text (will compile automatically first). */
__device__ int re_match(const char* pattern, const char* text, int* matchlength);
...
__device__ static int matchpattern(regex_t* pattern, const char* text, int* matchlength);
__device__ static int matchcharclass(char c, const char* str);
__device__ static int matchstar(regex_t p, regex_t* pattern, const char* text, int* matchlength);
__device__ static int matchplus(regex_t p, regex_t* pattern, const char* text, int* matchlength);
...
__device__ static int matchdot(char c);
...
__device__ void re_print(regex_t* pattern)
{
...
__device__ bool isalpha(char c)
{
...
__device__ static int matchquestion(regex_t p, regex_t* pattern, const char* text, int* matchlength)
{
    if (p.type == UNUSED)
        return 1;
    if (matchpattern(pattern, text, matchlength))
