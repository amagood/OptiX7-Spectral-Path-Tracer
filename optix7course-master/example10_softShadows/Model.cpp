    ...
    for (int shapeID=0;shapeID<(int)shapes.size();shapeID++) {
      ...
      for (int materialID : materialIDs) {
        ...
        for (int faceID=0;faceID<shape.mesh.material_ids.size();faceID++) {
          ...
          mesh->metallic = materials[materialID].shininess > 5000;
          mesh->transparency = materials[materialID].dissolve == 0;
          mesh->emission = (materials[materialID].emission[0] + materials[materialID].emission[1] + materials[materialID].emission[2]) != 0;
          mesh->emissionColor = vec3f(materials[materialID].emission[0], materials[materialID].emission[1], materials[materialID].emission[2]);
          mesh->refractionIndex = materials[materialID].ior;
        }
